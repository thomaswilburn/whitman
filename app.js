...
/*
 ...
 License: MIT
*/
(function(U,X,u){function A(b){return function(){var a=arguments[0],c;c="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.3.6/"+(b?b+"/":"")+a;for(a=1;a<arguments.length;a++){c=c+(1==a?"?":"&")+"p"+(a-1)+"=";var d=encodeURIComponent,e;e=arguments[a];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=d(e)}return Error(c)}}function Ra(b){if(null==b||Sa(b))return!1;var a=b.length;return b.nodeType===
...
define('text!_track.html',[],function () { return '<div class="track-ui flex column">\r\n  <input type="file" id="file-{{track.id}}">\r\n  <label for="file-{{track.id}}" class="fa fa-file-audio-o"></label>\r\n  <ul class="file-info">\r\n    <li> {{track.filename}}\r\n  </ul>\r\n</div>\r\n<span\r\n  class="cell flex"\r\n  ng-repeat="cell in track.sequence"\r\n  ng-class="{\r\n    active: cell.active,\r\n    current: clock.index == $index,\r\n    quarter: !($index % 2)\r\n  }"\r\n  ng-click="cell.active = !cell.active"\r\n></span>';});
